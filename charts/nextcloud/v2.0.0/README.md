...
```console
$ helm install kartoza/nextcloud
```
...
It also packages the [Kartoza PostGIS chart](https://github.com/kartoza/charts/tree/main/charts/postgis) which is required for bootstrapping a postgres deployment for the database requirements of the nextcloud application.
...
```console
$ helm install --name my-release kartoza/nextcloud
```
