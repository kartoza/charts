...
{{/*
Return GeoNode Media storageClass declaration
*/}}
{{- define "geonode.mediaDir.storageClass" -}}
{{- if .Values.global -}}
...
{{/*
Return Geonode static dir storageClass declaration
*/}}
{{- define "geonode.staticDir.storageClass" -}}
{{- if .Values.global -}}
	{{- if .Values.global.storageClass -}}
        {{- if (eq "-" .Values.global.storageClass) -}}
            {{- printf "storageClassName: \"\"" -}}
